    ...
    return (
        <div className="">
            ...
            <section className="border-b-2 border-gray-900">
                <div className="flex justify-center gap-4 items-center bg-gray-500 h-28 bg-no-repeat bg-cover bg-center"
                    style={{ backgroundImage: 'url(' + user.cover + ')' }}
                >

                    <div className="curosr-pointer bg-black/80 flex justify-center items-center  size-12 rounded-full">
            ...
            <section className="p-6 flex flex-col gap-4">
                ...
                <label>
                    <p className="text-lg text-gray-500 mb-2">Biografia</p>
